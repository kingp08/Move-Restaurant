...
class TakePictureScreen extends StatefulWidget {
  ...
  const TakePictureScreen({required this.camera, Key? key, required this.onTake, required this.onSkip}) : super(key: key);
              ...
              children: <Widget>[
                ...
                if (imageClicked)
                  GestureDetector(onTap: () {
                    Navigator.of(context).pop();
                    widget.onSkip();
                  }, child: Text("SKIP >>", style: const TextStyle(fontFamily: "Poppinssb", color: Colors.white, fontSize: 20))),
              ],
            );
          } else {
