            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Visibility(
                      visible: widget.withdrawHistoryModel.note.isNotEmpty, child: getTextBuild('Notes'.tr(), "${widget.withdrawHistoryModel.note}")),
                  Visibility(
                      visible: widget.withdrawHistoryModel.adminNote.isNotEmpty,
